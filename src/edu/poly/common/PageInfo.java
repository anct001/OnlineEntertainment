...
public static Map<PageType, PageInfo> pageRoute = new HashedMap();
	static {
		...
		pageRoute.put(PageType.SITE_ABOUTUS, new PageInfo("about us","/sites/home/gioiThieu.jsp",null));
		pageRoute.put(PageType.SITE_CONTACTS, new PageInfo("contact us","/sites/home/lienHe.jsp",null));		
