...
/****** Object:  Database [PolyOEAsg]    Script Date: 3/8/2021 5:20:27 PM ******/
CREATE DATABASE [PolyOEAsg]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PolyOEAsg', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\PolyOEAsg.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'PolyOEAsg_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\PolyOEAsg_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [PolyOEAsg] SET COMPATIBILITY_LEVEL = 140
GO
